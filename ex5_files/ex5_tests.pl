...
test(allDiff_06) :- sorteachCheck(allDiff([5, 1, 1, 1, 1, 5, 1, 1, 1, 1, 3, 5], Dups), (Dups), ([[1, 5]])).
...
test(unify_01) :- sorteachCheck(unify(a(x, y, 5), a(6, 5, 5), Mgu), (Mgu), [[[y, 5], [x, 6]]]).
test(unify_02) :- sorteachCheck(unify(c(z, a(x), y), c(a(a(d)), a(a(d)), a(a(d))), Mgu), (Mgu), [[[x, a(d)], [y, a(a(d))], [z, a(a(d))]]]).
test(unify_03) :- getFail(unify(c(a(x), y, x), c(a(6), d, a(6)), _Mgu)).
